...
const EventOptionsPage = () => {
  ...
  return (
    <div className="font-sans grid container-fluid h-full min-h-screen w-full transition-all duration-1000 bg-cover bg-center" style={{ backgroundImage: `url(${backgrounds[bgIndex]})` }}>
      <Header />
