...
const EventOptionsPage = () => {
  ...
  return (
    <div className="font-serif container-fluid h-screen w-screen transition-all duration-1000 bg-cover bg-center" style={{ backgroundImage: `url(${backgrounds[bgIndex]})` }}>
      <Header />
